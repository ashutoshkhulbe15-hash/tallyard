  ...
  switch (category) {
      ...
      return (
        <svg {...common}>
          ...
          <path
            ...
            fill="#111814"
          />
          <circle cx="160" cy="78" r="2" fill="#147A46" />
          {/* Decorative arrow */}
          <path
            ...
            opacity="0.5"
          />
          <circle cx="40" cy="135" r="3" fill="#147A46" />
        </svg>
      );
    ...
    case "concrete":
      return (
        <svg {...common}>
          ...
          <rect x="30" y="70" width="140" height="60" fill="#E7F3EC" stroke="#147A46" strokeWidth="1.5" rx="2" />
          <path d="M 60 70 L 60 130 M 100 70 L 100 130 M 140 70 L 140 130 M 30 100 L 170 100" stroke="#147A46" strokeWidth="1" opacity="0.4" />
          {valueLabel && (
            <text x="100" y="60" fontFamily="JetBrains Mono, ui-monospace, monospace" fontSize="10" fill="#147A46" fontWeight="600" textAnchor="middle">{valueLabel}</text>
          )}
          {/* Trowel */}
          <path d="M 40 35 L 60 30 L 65 45 L 45 50 Z" fill="#111814" />
          <rect x="60" y="38" width="20" height="3" fill="#111814" rx="1" />
          {/* Depth indicator */}
          <path d="M 175 70 L 185 70 L 185 130 L 175 130" stroke="#147A46" strokeWidth="1.5" fill="none" />
        </svg>
      );
    ...
    case "flooring":
      return (
        <svg {...common}>
          {/* Tile grid pattern */}
          <rect x="40" y="40" width="120" height="100" fill="#fff" stroke="#147A46" strokeWidth="1.5" rx="2" />
          <g stroke="#147A46" strokeWidth="1" opacity="0.5">
    ...
    case "landscaping":
      return (
        <svg {...common}>
          ...
          {/* Plant */}
          <circle cx="100" cy="60" r="18" fill="#147A46" opacity="0.3" />
          <path d="M 100 78 L 100 95" stroke="#111814" strokeWidth="2" />
          <path d="M 90 55 Q 85 45 95 40 M 110 55 Q 115 45 105 40" stroke="#147A46" strokeWidth="2" fill="none" />
          {valueLabel && (
            <text x="100" y="30" fontFamily="JetBrains Mono, ui-monospace, monospace" fontSize="10" fill="#147A46" fontWeight="600" textAnchor="middle">{valueLabel}</text>
          )}
        </svg>
    ...
    case "roofing":
      return (
        <svg {...common}>
          {/* House roof */}
          <path d="M 40 120 L 100 60 L 160 120 Z" fill="#fff" stroke="#147A46" strokeWidth="1.5" />
          <path d="M 60 105 L 140 105 M 55 115 L 145 115" stroke="#147A46" strokeWidth="1" opacity="0.5" />
          <rect x="50" y="120" width="100" height="30" fill="#F1F4EF" stroke="#147A46" strokeWidth="1" />
          {valueLabel && (
            <text x="100" y="50" fontFamily="JetBrains Mono, ui-monospace, monospace" fontSize="10" fill="#147A46" fontWeight="600" textAnchor="middle">{valueLabel}</text>
          )}
        </svg>
      );
    ...
    case "hvac":
      return (
        <svg {...common}>
          ...
          <rect x="40" y="50" width="120" height="90" fill="#fff" stroke="#147A46" strokeWidth="1.5" rx="4" />
          <circle cx="100" cy="95" r="22" fill="none" stroke="#147A46" strokeWidth="1.5" />
          <path d="M 100 73 L 100 95 L 115 95" stroke="#111814" strokeWidth="2" fill="none" strokeLinecap="round" />
          <path d="M 100 85 A 10 10 0 0 1 110 95" stroke="#147A46" strokeWidth="1" fill="none" />
          <path d="M 100 95 A 10 10 0 0 1 90 105" stroke="#147A46" strokeWidth="1" fill="none" />
          {valueLabel && (
    ...
    case "solar":
      return (
        <svg {...common}>
          {/* Sun + solar panel */}
          <circle cx="55" cy="55" r="15" fill="#147A46" />
          <g stroke="#147A46" strokeWidth="2" strokeLinecap="round">
          ...
          {/* Panel */}
          <path d="M 95 140 L 120 70 L 180 70 L 155 140 Z" fill="#111814" stroke="#147A46" strokeWidth="1.5" />
          <g stroke="#147A46" strokeWidth="0.5" opacity="0.6">
          ...
          {valueLabel && (
            <text x="140" y="160" fontFamily="JetBrains Mono, ui-monospace, monospace" fontSize="10" fill="#147A46" fontWeight="600" textAnchor="middle">{valueLabel}</text>
          )}
        </svg>
      );
