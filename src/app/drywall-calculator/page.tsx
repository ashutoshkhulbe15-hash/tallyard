...
export const metadata: Metadata = {
  ...
  description:
    "Free drywall calculator: sheets, joint compound, tape, and screws for any room. Covers installation cost, repair cost, and finish levels. No signup.",
  alternates: { canonical: "/drywall-calculator" },
  openGraph: {
    title: "Drywall & Sheetrock Calculator: Sheets, Mud & Cost",
    description:
      "Free drywall calculator: sheets, mud, tape, and screws. Covers installation cost, repair cost, and finish levels. No signup.",
